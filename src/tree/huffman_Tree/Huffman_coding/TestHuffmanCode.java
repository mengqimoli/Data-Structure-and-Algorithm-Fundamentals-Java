...
public class TestHuffmanCode {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("原始字母:" + msg);
        System.out.println("原始bytes:" + Arrays.toString(bytes));
        System.out.println("原始bytes的长度:" + bytes.length);
        //进行赫夫曼编码压缩
        byte[] b = huffmanZip(bytes);
        System.out.println("压缩之后b的长度:" + b.length);
        //使用赫夫曼编码进行解码
        byte[] newBytes = decode(huffCodes, b);
        System.out.println("压缩解码之后字母:" + new String(newBytes));
        System.out.println("压缩解码之后newBytes:" + Arrays.toString(newBytes));
    }
